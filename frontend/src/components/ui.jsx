  ...
  return (
    <div className="scard">
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="font-extrabold mt-0.5 leading-none truncate"
          style={{ color:accent, fontFamily:'Plus Jakarta Sans,sans-serif', fontSize:'1.65rem', letterSpacing:'-0.03em' }}>
          {value ?? '—'}
        </p>
      </div>
    </div>
