    ...
    <div className="space-y-6 anim-up">
      ...
      <div style={{
        ...
        <div style={{ position:'relative' }}>
          <p style={{ fontSize:11,fontWeight:600,color:'#c4b5fd',textTransform:'uppercase',letterSpacing:'.08em',marginBottom:6 }}>Administrator Panel</p>
          <h1 style={{ fontSize:'1.6rem',fontWeight:800,fontFamily:'Plus Jakarta Sans,sans-serif',letterSpacing:'-0.02em' }}>System Overview</h1>
          <p style={{ color:'#ddd6fe',fontSize:13,marginTop:4 }}>Full access to all clinic operations and data</p>
        </div>
      </div>
        ...
        {[
          ...
          <button key={label} onClick={() => navigate(path)}
            ...
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl flex items-center justify-center text-xl transition-transform group-hover:scale-110 flex-shrink-0"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        <div className="lg:col-span-2 card">
          ...
          <ResponsiveContainer width="100%" height={220}>
            <BarChart data={data?.daily||[]} barSize={24} margin={{ top:8,right:4,left:-16,bottom:0 }}>
              <defs>
                {BAR_COLORS.map((c,i) => (
